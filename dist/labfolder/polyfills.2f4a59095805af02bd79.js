      ...
      !(function() {
        ...
        !(function(e) {
          ...
          var o,
            ...
            h = !1;
          function v(t) {
            0 === P && 0 === p.length && (o || (e[l] && (o = e[l].resolve(0))), o ? o[f](d) : e[s](d, 0)),
              t && p.push(t);
          }
          function d() {
            if (!h) {
                  ...
                  function() {
                    ...
                    if (!a || a(t, h, p, arguments)) {
                      ...
                      var S,
                        ...
                        j = !1;
                      if (D) {
                        if (((j = !0), _)) for (m = 0; m < D.length; m++) if (Z(D[m], h)) return;
                      } else D = p[b] = [];
                        ...
                        o.forEach(function(t) {
                          ...
                          if (u.hasOwnProperty(t)) {
                            ...
                            s && s.value
                              ? ((s.value = p(s.value, c)),
                                (a = (i = s).configurable),
                                Q((r = n.prototype), (o = t), (i = G(r, o, i)), a))
                              : (u[t] = p(u[t], c));
