(function() {
  ...
  (t = {}),
    (s = this),
    'undefined' != typeof module && null !== module && module.exports ? (module.exports = t) : (s.ipaddr = t),
    (a = function(r, t, n, e) {
      var i, o;
    ...
    (t.IPv4 = (function() {
      ...
      return (
        ...
        (r.prototype.prefixLengthFromSubnetMask = function() {
          var r, t, n, e, i, o, a;
          for (
            a = { 0: 8, 128: 7, 192: 6, 224: 5, 240: 4, 248: 3, 252: 2, 254: 1, 255: 0 }, r = 0, i = !1, t = n = 3;
            n >= 0;
            t = n += -1
          ) {
    ...
    (t.IPv6 = (function() {
      ...
      return (
        ...
        (r.prototype.match = function(r, t) {
          var n;
          if ((void 0 === t && ((r = (n = r)[0]), (t = n[1])), 'ipv6' !== r.kind()))
    ...
    (r = function(r, t) {
      ...
      for (
        (p = (r.match(o.zoneIndex) || [])[0]) && ((p = p.substring(1)), (r = r.replace(/%.+$/, ''))), n = 0, e = -1;
        (e = r.indexOf(':', e + 1)) >= 0;
    ...
    (t.IPv4.parseCIDR = function(r) {
      var t, n;
      if ((n = r.match(/^(.+)\/(\d+)$/)) && (t = parseInt(n[2])) >= 0 && t <= 32) return [this.parse(n[1]), t];
    ...
    (t.IPv6.parseCIDR = function(r) {
      var t, n;
      if ((n = r.match(/^(.+)\/(\d+)$/)) && (t = parseInt(n[2])) >= 0 && t <= 128) return [this.parse(n[1]), t];
